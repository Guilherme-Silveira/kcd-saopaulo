...
openai.api_key = os.environ['LLM_API']
g_model = "gpt-3.5-turbo-0613"

# Connect to Elasticsearch cluster
def es_connect_host(es_host, es_user, es_pass):
...
# Connect to Elastic Cloud Deployment
...
def search(query_text):
    ...
    host_es_host = os.environ['ES_URI']
    host_es_pass = os.environ['ES_PASSWORD']
    host_es_user = os.environ['ES_USER']

    es = es_connect_host(host_es_host, host_es_user, host_es_pass)
...
st.title("KCD São Paulo - Brasil 2024")
